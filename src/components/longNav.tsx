...
export default function LongNav(props: Props) {
	...
	useEffect(() => {
		...
		const updateScrollDir = () => {
			...
			props.setScrollDir(scrollY > lastScrollY ? "scrolling down" : "scrolling up")
		...
		>
			<ul className="list-none mr-[40px] grid items-baseline text-inherit self-center grid-cols-longNav">
				...
				{props.userState.loggedInStatus == "LOGGED_IN"
					? [
							<li className="font-fira py-0 pr-0 pl-[4px] text-[.75rem] leading-[45px]" key={3}>
							...
							<li className="font-fira p-0 text-[.75rem] leading-[45px]" key={5}>
					...
					: [
							<li className="font-fira py-0 pr-0 pl-[4px] text-[.75rem] leading-[45px]" key={6}>
							...
							<li className="font-fira p-0 text-[.75rem] leading-[45px]" key={8}>
