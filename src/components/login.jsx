...
export default function Login(props, { error, reset }) {
	...
	const [data, formAction] = useFormState(AuthenticateUser, initialState)
	...
	return (
		<div className={`LoginWrapperNew ${props.openLoginMenu ? " top-0" : "-top-[555px]"}`}>
			<div className="CardNew">
				...
				>
					<div className="FormItem">
						<Label className={state2.emailFieldActive ? "field-active" : ""}>email</Label>
						<InputIcon style={{ backgroundImage: `url('/tinyManLogo.png')` }}></InputIcon>
					...
					<div className="FormItem">
						<Label className={state2.passwordFieldActive ? "field-active" : ""}>password</Label>
						<InputIcon style={{ backgroundImage: `url('/lockIcon.png')` }}></InputIcon>
